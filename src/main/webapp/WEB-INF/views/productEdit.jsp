    ...
    <div class="card">
        <div class="card-body offset-sm-2 col-sm-8">
            ...
            <form:form
                ...
                <div class="form-group row">
                    <label for="quantity" class="col-md-4 col-form-label">Active</label>
                    <div class="col-md-8">
                        <form:checkbox id="active" path="active" cssClass="form-control"/>
                        <form:errors path="active" cssClass="form-control-feedback small my-text-red" element="em"/>
                    </div>
                </div>
